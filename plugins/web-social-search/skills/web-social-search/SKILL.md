---
description: Read, search, or extract data from the internet across multiple platforms (web pages, YouTube, Reddit, GitHub, RSS, Hacker News). Zero-config, keyless access.
---

# Web and Social Search — Multi-Platform Internet Access
...
- Command: `python3 ${CLAUDE_PLUGIN_ROOT}/servers/web-social-search/server.py`
...
|---|---|---|
| **read_webpage** | Read any web page to clean markdown (Jina Reader) | Yes |
